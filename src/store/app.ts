...
const mockPosts = [
  {
    ...
    content: {
      ...
      description: 'Something I wrote for my Orchestration I final. I imagined an epic fantasy adventure! Hope you can picture that too when you listen. Any feedback is welcome!',
